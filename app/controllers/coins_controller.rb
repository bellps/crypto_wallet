class CoinsController < ApplicationController
  #isso executa antes das ações estabelecidas e envia pra elas, evitando repetição de código
  before_action :set_coin, only: [:show, :edit, :update, :destroy]
  before_action :get_types, only: [:new, :edit]
  ...
  private
    ...
    def get_types
      @types = MiningType.all.pluck(:description, :id)
    end
end
